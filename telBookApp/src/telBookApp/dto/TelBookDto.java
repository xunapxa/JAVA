...
//				dto.getId(),
	...
	public static TelBook fromDtos(TelBookDto dto) {
		return new TelBook(
				dto.getId(),
				dto.getName(),
				dto.getAge(),
	...
	public static TelBookDto makeDto (String name, int age, String address, String phone) {
		return new TelBookDto(name, age, address, phone);
	}
	
	public static TelBookDto makeDto (Long id, String name, int age, String address, String phone) {
		return new TelBookDto(id, name, age, address, phone);
	}
